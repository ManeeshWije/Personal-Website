    ...
    <div className="animate-in slide-in-from-left-20 duration-700 p-5 pt-8 flex flex-col justify-center items-center">
      ...
      <section>
        ...
        <ul>
          <Typography variant="lead" as="li">
            ...
            exactly where something went wrong and figure out the solutions with
            minimal guidance when it comes to discovering/fixing bugs, writing
            tests, etc.
          </Typography>
          <br />
          <Typography variant="lead" as="li">
            ...
            show the existing developers that I can be counted on when it comes
            to working on the codebase. I also want to make sure that I can
            answer most of the questions that the other interns might have which
            will allow them to grow/mature while I do.
          </Typography>
          <br />
          <Typography variant="lead" as="li">
            ...
            build off of the knowledge I already know and start to focus on more
            advanced topics of JavaScript that the DCP uses in their codebase.
            By doing this, I'm not only broadening my personal understanding of
            the languages and specific techniques used with them, but I'm also
            benefiting the companies I may work for in the future that use the
            same technologies.
          </Typography>
        </ul>
        ...
        <ul>
          ...
          <Typography variant="lead" as="li">
            ...
            peers with their on-boarding or any other questions they had. I also
            started contributing to the codebase early on which allowed me to
            grasp an understanding of proper coding conventions and the whole PR
            process. I passed this knowledge down to the other interns when it
            was their time to do the same. To showcase more leadership, I even
          ...
          <Typography variant="lead" as="li">
            ...
            JavaScript, I forced myself to learn it thoroughly even though I had
            previous experience with the language. I had even learned new things
            about it throughout my time developing. I also learned how to
            properly use a debugger and what it means to have one at all times
            whether you are writing software or debugging it. I heavily used
            these techniques and did not have experience using them prior.
            Overall, the way I fixed bugs and wrote software saw an increase in
            efficiency after working at this company.
          </Typography>
        </ul>
      </section>
      <div className="pt-8"></div>
      <section>
        ...
        <Typography variant="lead">
          ...
          multiple computers on different compute groups to do work. I also did
          some front-end UI work in React.js for the company's new portal page.
          Looking back, I was able to learn more about Node.js, SQL, compute
          clusters, React.js, and much more. I also learned a lot of new skills
          that I would not have come across in school. These include debugging
          tools, how to contribute to an existing codebase, how to make a PR,
          how to adhere to coding standards/styles, etc. This was an amazing
          learning experience as I got to work with tools and frameworks that I
          had never seen before and that broadened my understanding of the
          industry.
        </Typography>
        <div className="pt-8"></div>
        ...
        <Typography variant="lead">
          ...
          for the immense support as well as always pushing me to be a leader in
          every case possible (Thanks for letting me spill my Neovim knowledge
          onto you).
        </Typography>
      </section>
    </div>
