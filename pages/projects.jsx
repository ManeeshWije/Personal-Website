...
export default function Projects() {
  return (
    <>
      ...
      <div className='md:overflow-hidden animate-in slide-in-from-right-12 duration-2s flex flex-col justify-center flex-wrap gap-x-9 gap-y-20 py-8 md:flex-row'>
