  ...
  return (
    <div className="text-center flex p-12 animate-in duration-500 slide-in-from-left-36 flex-col justify-center items-center">
      ...
      <Typography variant="lead" className="w-7/12" color="blue-gray">
        ...
        React.js, and many more. To see what I'm currently working on and other
        past projects, you can check out my projects page or my Github. Have a
        question? Contact me through email, LinkedIn, or the form on this
        website.
      </Typography>
    </div>
  );
